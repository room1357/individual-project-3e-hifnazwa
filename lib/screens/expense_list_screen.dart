...
class ExpenseListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, List<Expense>> groupedByCategory = groupBy(
      expenses,
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text("Total semua: ${_calculateTotal(expenses)}"),
          Text("Total makanan: ${_calculateTotal(foodExpenses)}"),
          Text("Jumlah > 100k: ${expensiveItems.length} item"),
          Container(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) { // Fungsi pembuat widget untuk setiap item
                ...
                return Card( /* Widget untuk item */
                  ...
                  elevation: 2,
                  child: ListTile(
                    leading: CircleAvatar( /* Icon di kiri */
                    ...
                    trailing: Text( /* Informasi di kanan */
